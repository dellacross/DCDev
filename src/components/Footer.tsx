  ...
  return (
    <footer className='text-white text-center lg:h-[40px] md:h-[20px] h-[60px] flex items-center justify-center box-border lg:text-lg text-md'>
      ...
      <nav className='flex md:hidden items-center justify-around gap-x-5 h-full w-full border-t-2 border-[#222222] box-border sm:text-sm text-xs'>
        <div 
          className='flex w-full justify-center items-center lg:gap-x-4 gap-x-1 gap-y-1 text-[#8D4BB9] underline-offset-4 cursor-pointer flex-col'
          onClick={() => handleClick({ endpoint: '/about', color: '#8D4BB9', name: 'Sobre mim' })}
        >
          <span><Lightbulb /></span>
          <p className='sm:text-sm text-xs text-center'>Sobre</p>
        </div>
        <div 
          className='flex w-full justify-center items-center lg:gap-x-4 gap-x-1 gap-y-1 text-[#27A5F1] underline-offset-4 cursor-pointer flex-col'
        ...
        <div 
          className='flex w-full justify-center items-center lg:gap-x-4 gap-x-1 gap-y-1 text-[#F56565] underline-offset-4 cursor-pointer flex-col'
        ...
        <div 
          className='flex w-full justify-center items-center lg:gap-x-4 gap-x-1 gap-y-1 text-[#29903B] underline-offset-4 cursor-pointer flex-col'
        ...
        <div 
          className='flex w-full justify-center items-center gap-x-1 gap-y-1 text-[#FFDF5E] underline-offset-4 cursor-pointer flex-col'
